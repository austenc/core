...
@section('content')
	<div class="row">
	{!! Form::model($observer, ['route' => ['account.update', 'observer', $observer->id], 'method' => 'PUT']) !!}
		<div class="col-md-9">
			<h1>Your Account</h1>
			...
			<div class="well">
				<div class="form-group">
					...
					{!! Form::text('username', $observer->user->username) !!}
			...
			<div class="well">
				<div class="form-group">
					...
					{!! Form::text('email', $observer->user->email) !!}
					<span class="text-danger">{{ $errors->first('email') }}</span>
				</div>
				<div class="form-group">
					{!! Form::label('phone', 'Main Phone') !!} @include('core::partials.required')
					{!! Form::text('phone') !!}
		...
		{!! Form::hidden('first', $observer->first) !!}		
		{!! Form::hidden('middle', $observer->middle) !!}
		{!! Form::hidden('last', $observer->last) !!}
		{!! Form::hidden('payable_rate', $observer->payable_rate) !!}
	{!! Form::close() !!}
	</div>
@stop