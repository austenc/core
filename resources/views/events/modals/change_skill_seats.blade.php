{!! Form::open(['route' => array('events.skill.change_seats', $event->id, $skill->id)]) !!}
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
		<h4 class="modal-title">Change Skill Seats - {{ $skill->name }}</h4>
	</div>
	...
	<div class="modal-body">
		<ul class="list-group">
			<li class="list-group-item">
  			...
  			<li class="list-group-item">
    			<span class="badge alert-success">{{ $skill->pivot->open_seats }}</span>
    			Current
  			</li>
  			<li class="list-group-item">
