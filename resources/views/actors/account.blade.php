...
@section('content')
	<div class="row">
	{!! Form::model($actor, ['route' => ['account.update', 'actor', $actor->id], 'method' => 'PUT']) !!}
		<div class="col-md-9">
			<h1>Your Account</h1>
			...
			<div class="well">
				<div class="form-group">
					...
					{!! Form::text('username', $actor->user->username) !!}
			...
			<div class="well">
				<div class="form-group">
					...
					{!! Form::text('email', $actor->user->email) !!}
		...
		{!! Form::hidden('first', $actor->first) !!}		
		{!! Form::hidden('middle', $actor->middle) !!}
		{!! Form::hidden('last', $actor->last) !!}
	{!! Form::close() !!}
@stop